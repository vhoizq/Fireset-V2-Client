            ...
            <div className="mx-auto mt-20 max-w-lg">
              <div>
                <div className="text-center">
                  ...
                  <div className="mt-6">
                    <a
                      href="https://apis.roblox.com/oauth/v1/authorize?client_id=2682885889385043103&redirect_uri=http://localhost:3000/auth/redirect&scope=openid+profile&response_type=Code&prompts=login+consent&nonce=12345&state=6789"
