...
export default function TermsPage() {
  return (
    <div className="flex flex-col gap-4 w-screen min-h-screen bg-gray-50  py-36 px-64">
      ...
      <span className="text-indigo-950 text-3xl font-bold">
        Terms of Service
      </span>
      <span className="text-indigo-950 text-sm mb-12">{`Please read these Terms of Service ("Terms") carefully before using our website. These Terms constitute a legal agreement between you ("User" or "you") and Fireset ("we," "us," or "our"). By accessing or using our website, you agree to be bound by these Terms.`}</span>
      <div className="flex flex-col gap-2">
        <span className="text-indigo-950 text-lg font-semibold ml-8">
