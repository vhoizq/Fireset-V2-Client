...
export default function ClientPage() {
    ...
    const navigation = [
        ...
        { name: 'Community Insights', href: `/client/dashboard/${path.split("/")[3]}/insights`, icon: GlobeAltIcon, current: false, paid: true },
        { name: 'Security Actions', href: `/client/dashboard/${path.split("/")[3]}/security`, icon: LockClosedIcon, current: true, paid: false },
                    ...
                    <main className="flex-1">
                        <div className="py-6">
                            <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                                ...
                                <h1 className="text-md font-medium text-gray-900">Edit your Security Actions for <span style={{ color: `${workspaceInformation.group.color}` }}>{workspaceInformation.group.name}</span></h1>
                            </div>
                            <div className="mx-auto max-w-7xl">


                                <div className="mr-6 ml-8 mt-5 grid grid-cols-1 sm:grid-cols-2 gap-2">
                                    <div className="relative w-full text-left  rounded-lg p-6 border border-gray-300">
                                        <p className="text-lg sm:text-base font-semibold">Automatic Lockdown</p>
                                        <p className="font-normal text-gray-700 text-lg dark:text-dark-content-emphasis mt-1 text-inherit">Examply</p>
                                    </div>
                                    <div className="relative w-full text-left  rounded-lg p-6 border border-gray-300">
                                        <p className="text-lg sm:text-base font-semibold">Threat Notifications</p>
                                        <p className="font-normal text-lg text-gray-700 dark:text-dark-content-emphasis mt-1 text-inherit" >Examply</p>
                                    </div>
